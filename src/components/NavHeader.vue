  ...
  <header class="header">
    ...
    <div class="navbar">
      <div class="navbar-left-container">
        <!-- <a href="javascript:;" class="navbar-forward forword-show" 
           v-show="isShow" @click="forward">
          <h2 class="circle-left"> &lt;</h2>
        </a> -->
        <a href="/">
      ...
      <div class="navbar-right-container" style="display: flex;">
        <div class="navbar-menu-container">
          ...
          <router-link class="navbar-link" to="/login" v-if="!nickName">登录</router-link>
...
.navbar-left-container .navbar-forward {
  display: none;
}
.navbar-left-container .navbar-forward .circle-left {
  width: 30px;
  height: 30px;
  line-height: 22px;
  color: #fff;
...
@media screen and (max-width: 480px) {
  ...
  .navbar-left-container .navbar-brand-logo {
    margin-left: -20px;
  }
}
</style>
