<template>
  <div>
      ...
      <div class="container">
        <div class="checkout-addr">
          <div class="page-title-normal">
            <h2 class="page-title-h2"><span> 下 单 </span></h2>
          </div>
          <!-- process step -->
            ...
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in addressListFilter"
                    ...
                    @click="checkIndex = index; selectAddrId = item.addressId">
                  <dl>
                    <dt>{{item.userName}}</dt>
          ...
          <div class="lemall-msg-info hidden">
            <span>您选择的区域不在我们的送货区域内。请在我们的送货区域内选择另一个送货地址。</span>
          </div>
          <div class="shipping-method-wrap">
            <div class="shipping-method">
              <ul>
                <li class="check">
                  <div class="name">顺丰标准运输</div>
                  <div class="price">包邮</div>
                  <div class="shipping-tips">
                    <p>一旦发运, 订单应抵达目的地在1-7 工作日，请耐心等候！</p>
                  </div>
                </li>
              </ul>
            </div>
          ...
          <div class="next-btn-wrap">
            <a href="javascript:;" class="btn btn--m btn--red" @click="next">下一步</a>
          </div>
        </div>
      </div>
    </div>
    ...
    <modal :mdShow="hasAddress" @close="closeModal">
