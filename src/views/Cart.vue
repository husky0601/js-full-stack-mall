  ...
  <div>
                  ...
                  <div class="item-quantity">
                    <div class="select-self select-self-open">
                      <div class="select-self-area">
                        <a class="input-sub" @click="editCart('mimu',item)">-</a>
        ...
        <div class="cart-foot-wrap">
          <div class="cart-foot-inner">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                <a class="btn btn--red" :class="{'btn--dis':checkedCount==0}" @click="checkOut">&nbsp;&nbsp;下 单&nbsp;&nbsp;</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <Modal :mdShow="mdConfirm" @close="closeModal">
      ...
      <div slot="btnGroup">
        ...
        <a class="btn btn--m btn--red" href="javascript:;" @click="mdConfirm = false">&nbsp;&nbsp;&nbsp;关闭&nbsp;&nbsp;&nbsp;</a>
      </div>
    </Modal>
  ...
  methods: {
    ...
    checkOut() {
      ...
      if (window.localStorage) {
          localStorage.setItem("saveProduct",JSON.stringify(this.saveProduct))
